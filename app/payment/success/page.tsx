...
import type { OrderStatus, UserPlan, UserRole } from '@/lib/domain-types';
            ...
            <div className="space-y-6">
              <div className="bg-blue-50 rounded-xl p-6">
                ...
                <p className="text-2xl font-bold text-blue-600 mb-2">
                  {orderDetails.user.plan === USER_PLAN.FREE ? '免费版' : 
                   orderDetails.user.plan === USER_PLAN.MONTHLY ? '专业版' : '年度版'}
                </p>
